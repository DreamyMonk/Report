        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardHeader>
                ...
                <CardDescription>
                    Automated summary, risk assessment, and suggested steps generated by our AI.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div>
                    <h3 className="font-semibold mb-2">Summary</h3>
                    <p className="text-sm text-muted-foreground">{report.aiSummary || 'N/A'}</p>
                </div>
                <div>
                    <h3 className="font-semibold mb-2">Risk Assessment</h3>
                    <p className="text-sm text-muted-foreground">{report.aiRiskAssessment || 'N/A'}</p>
                </div>
                 <div>
                    <h3 className="font-semibold mb-2">Severity Reasoning</h3>
                    <p className="text-sm text-muted-foreground">{report.aiReasoning || 'N/A'}</p>
                </div>
                <div>
